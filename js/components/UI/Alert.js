const Alert = ({ message, type, onClose, duration = 2000 }) => {
  ...
  return (
    <div className="fixed z-[70] top-2 left-1/2 transform -translate-x-1/2 w-auto max-w-md py-5 px-6 bg-cleanWhite dark:bg-dark-300 bg-opacity-50 dark:bg-opacity-50 backdrop-blur-md backdrop-filter text-black dark:text-white rounded-md border border-secondary dark:border-gray-600 shadow-sm">
      <button
        type="button"
