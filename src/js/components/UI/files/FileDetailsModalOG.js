const FileDetailsModal = ({ file, onClose }) => {
  ...
  return (
    <div>
      <div className="fixed inset-0 flex items-center justify-center z-[60] bg-gray-500 dark:bg-dark-300 bg-opacity-50 dark:bg-opacity-50 backdrop-blur-md backdrop-filter">
        <div
          className="bg-white dark:bg-dark-200 p-6 rounded-xl shadow-2xl w-full max-w-[90%] lg:max-w-[900px] min-h-[350px] max-h-[85vh] overflow-auto relative
"
        >
          {/* popup header part  */}
          <div class="flex items-start justify-between pb-5 border-b rounded-t dark:border-gray-600">
