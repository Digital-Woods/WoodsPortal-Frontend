  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        ctaBackgroundColor:`${sidebarCtaStyles.backgroundColor || '#3d4d5e'}`,
        ctaTextColor:`${sidebarCtaStyles.textColor || '#FFFFFF'}`,
        ctaButtonBackgroundColor:`${sidebarCtaStyles.buttonBackgroundColor || '#14BBA4'}`,
        ctaButtonTextColor:`${sidebarCtaStyles.buttonTextColor || '#FFFFFF'}`,
