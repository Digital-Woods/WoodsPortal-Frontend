...
import { ProseMirrorMenuInsertLinkPopUp } from './ProseMirrorMenuInsertLinkPopUp';

export const ProseMirrorLinkView = (attrs: any, type: any) => {
  const mark = attrs
  const view = type
  ...
  let isOpenLinkPopup: any = false;
  let linkPopupContainer: any = null;
  ...
  dom.addEventListener("click", (event: any) => {
    ...
    if (target) {
      ...
      if (isOpenLinkPopup) {
        ...
        const root = createRoot(linkPopupContainer);
        root.render(
