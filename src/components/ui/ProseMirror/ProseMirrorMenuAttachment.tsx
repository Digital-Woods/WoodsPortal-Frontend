...
const EditorAttachmentUploadMenu = ({
  ...
  const uploadImageToAPI = async (pmView: any, formData: any) => {
    setisLoadingUoloading(true);
    try {
      const response = await axios({
        method: attachmentUploadMethod,
      ...
      setAttachmentId((prevAttachments: any) => 
...
const renderReactAttachmentUploadComponent = (
  ...
  attachmentUploadMethod: any,
  setUploadedAttachments: any,
...
export const customMenuItemAttachment = (
  attachmentUploadUrl: any,
  attachmentUploadMethod: any,
  setUploadedAttachments: any,
  setisLoadingUoloading: any,
