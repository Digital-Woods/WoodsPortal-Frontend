    ...
    return (
        <div className="grid grid-cols-5 md:mb-4 mb-3 h-[66vh]">
            {Array(5).fill(0).map((_, index) => (
                <div key={index} className={`relative flex flex-col h-full bg-[#f5f8fa] dark:bg-dark-500 border dark:border-gray-600 overflow-y-auto CUSTOM-hide-scrollbar first:border-r-0 last:border-l-0 first:rounded-s-md last:rounded-e-md`}>
                    {/* Column Title */}
