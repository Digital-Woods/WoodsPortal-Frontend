...
export const SvgRenderer = ({ svgContent }: any) => {
  ...
  const renderSvg = () => {
    ...
    return (
      <svg
        {...Array.from(svgElement.attributes).reduce((attrs: any, attr: any) => {
          attrs[attr.name] = attr.value;
          return attrs;
        }, {})}
      >
        {Array.from(svgElement.childNodes).map((node: any, index: any) => {
